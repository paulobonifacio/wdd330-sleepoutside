...
document.addEventListener("DOMContentLoaded", () => {
    ...
    //         const productCard = event.target.closest("a");
    //         if (productCard) {
    //             const productClone = productCard.cloneNode(true);
    //             const quickViewButton = productClone.querySelector(".quick-view");
    //             if (quickViewButton) quickViewButton.remove();

    //             const description = productCard.querySelector(".hidden-description")?.textContent || "No description available.";
    ...
    //             closeQuickViewBtn.textContent = "Close Quick View";
    //             closeQuickViewBtn.classList.add("close-quick-view");
    //             closeQuickViewBtn.style.cssText = "display:block; margin: 10px auto; padding: 10px 15px; background:#444; color:white; border:none; cursor:pointer;";
